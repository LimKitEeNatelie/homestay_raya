...
import 'package:homestay_raya/views/screens/detailsreen.dart';
...
class MyHomestayScreen extends StatefulWidget {
  ...
  @override
  State<MyHomestayScreen> createState() => _MyHomestayScreenState();
}
...
//check permission,get location,get address return false if any problem.
    ...
    http
      ...
      if (response.statusCode == 200) {
        ...
        if (jsondata['status'] == 'success') {
          ...
          titlecenter = "No Homestay Availablee";
        }
      } else {
        titlecenter = "No Homestay Availableee"; //status code other than 200
        homestayList.clear();
      }
      setState(() {}); //refresh UI
    });
  ...
  void _deleteHomestay(index) {
    try {
      http.post(
          Uri.parse("${Config.server}/homestay_raya/php/delete.homestay.php"),
          body: {
